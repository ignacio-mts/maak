...
const toneDot = {
  ...
  neutral: "border-[var(--primary)] bg-[var(--surface)]",
} as const;
          ...
          <section className="card">
            ...
            {c.bars.map((b) => (
              <div key={b.label} className="mb-2 grid grid-cols-[120px_1fr_52px] items-center gap-2.5">
                ...
                <div className="relative h-5 overflow-hidden rounded bg-[var(--surface-2)]">
                  <div
          ...
          <div className="grid gap-4 md:grid-cols-[1.15fr_.85fr]">
            ...
            <section className="card">
              ...
              {c.gaps.length === 0 ? (
                ...
                c.gaps.map((g) => (
                  <div key={g.id} className="mb-2 rounded-lg border border-[var(--fail-line)] bg-[var(--fail-bg)] px-3 py-2.5">
            ...
            {!(c.verified || c.status === "verified") ? (
              <>
                <button
                  ...
                  className="mb-2 w-full rounded-lg bg-[var(--action)] px-3 py-2.5 text-[13px] font-bold text-[var(--action-fg)] hover:bg-[var(--action-hover)] disabled:opacity-40"
                >
                  Avanzar etapa
                </button>
                <button
                  ...
                  className="mb-2 w-full rounded-lg border border-[var(--line)] bg-[var(--surface)] px-3 py-2.5 text-[13px] font-bold hover:border-[var(--line-strong)]"
                >
